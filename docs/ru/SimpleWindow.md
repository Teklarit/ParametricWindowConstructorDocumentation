...
- `PWCTrapezoidalWindowConstructor` - окно-трапеция. Без заполнения. Регулируются: ширина, левая высота, правая высота.
- `PWC5SidedTrapezoidalWindowConstructor` - прямоугольное окно со срезанным углом. Без заполнения. Регулируются: ширина, высота, сторона среза (левая/правая), отступы от угла по высоте и ширине для среза.
- `PWCRoundWindowConstructor` - круглое окно. Без заполнения. Регулируются: радиус, к-во сегментов.
